...
TrailRenderer.Shader.TexturedVertexVars = [TrailRenderer.Shader.BaseVertexVars, "varying vec2 vUV;", "uniform float dragTexture;"].join("\n");

TrailRenderer.Shader.BaseFragmentVars = ["varying vec4 vColor;", "uniform sampler2D tex;"].join("\n");

TrailRenderer.Shader.TexturedFragmentVars = [TrailRenderer.Shader.BaseFragmentVars, "varying vec2 vUV;"].join("\n");
...
TrailRenderer.Shader.BaseFragmentShader = [TrailRenderer.Shader.BaseFragmentVars, "void main() { ", "gl_FragColor = vColor;", "}"].join("\n");
